...
const I18N = {
  zh: {
    ...
    secCalendar: '月度日历', calThisMonth: '本月', calThisYear: '今年',
    calWeekdays: '日,一,二,三,四,五,六',
    insStreakWeeks: '连续周数', insWeeksUnit: '周',
    habitLast: '最近',
    fpByPlace: '按地点聚合', fpAllPoints: '全部起点', fpCityHeat: '城市热度',
    fpSpot: '足迹点', fpCities: '城市', fpSpots: '个足迹点', fpTotalKm: '累计里程',
    fpAllYears: '全部年份', fpLoadingGeo: '城市边界加载中…',
    fpHeatFew: '少', fpHeatMany: '多', fpInCities: '个城市中',
    fpHint: 'GPS 起点聚合（圆越大次数越多） · 城市热度模式：颜色越深运动越多',
    less: '少', more: '多',
    filterAll: '全部',
  ...
  en: {
    ...
    secCalendar: 'Month Calendar', calThisMonth: 'This month', calThisYear: 'This year',
    calWeekdays: 'Su,Mo,Tu,We,Th,Fr,Sa',
    insStreakWeeks: 'Week Streak', insWeeksUnit: 'wks',
    habitLast: 'Last',
    fpByPlace: 'By place', fpAllPoints: 'All start points', fpCityHeat: 'City heat',
    fpSpot: 'Spot', fpCities: 'cities', fpSpots: 'spots', fpTotalKm: 'total distance',
    fpAllYears: 'All years', fpLoadingGeo: 'Loading city boundaries…',
    fpHeatFew: 'Few', fpHeatMany: 'Many', fpInCities: 'cities',
    fpHint: 'GPS start points (bigger bubble = more visits) · City heat: darker = more activities',
    less: 'Less', more: 'More',
    filterAll: 'All',
